...
PaletteProvider.prototype.getPaletteEntries = function() {
  ...
  assign(actions, {
    ...
    // "create.start": createAction("bpmn:EndEvent", "event", "bpmn-icon-start-event-compensation", translate("Create StartEvent")),
    ...
    "create.service-task": createAction("bpmn:ServiceTask", "activity", "bpmn-icon-arm", translate("Create Gateway")),
    "create.user-task": createAction("bpmn:UserTask", "activity", "bpmn-icon-car", translate("Create User Task")),
    ...
    // "create.data-try": createAction("bpmn:", "data-store", "bpmn-icon-data-store", translate("Create DataStoreReference")),
