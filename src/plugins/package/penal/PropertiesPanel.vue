...
<!--      <el-collapse-item>-->
<!--        <div slot="title" class="panel-tab__title"><i class="el-icon-info"></i>111</div>-->
...
<!--      <el-collapse-item name="condition" v-if="moveVisible" key="move">-->
<!--        <div slot="title" class="panel-tab__title"><i class="el-icon-s-order"></i>动作</div>-->
<!--        <element-form :id="elementId" :type="elementType" />-->
<!--      </el-collapse-item>-->
...
<!--      </el-collapse-item>-->
      ...
      <el-collapse-item name="other" key="other">
        <div slot="title" class="panel-tab__title"><i class="el-icon-s-promotion"></i>功能描述</div>
        <element-other-config :id="elementId" />
      </el-collapse-item>
<!--      <el-collapse-item name="other2" key="other2">-->
<!--        <div slot="title" class="panel-tab__title"><i class="el-icon-s-promotion"></i>其他2</div>-->
<!--        <element-other-config2 :id="elementId" />-->
<!--      </el-collapse-item>-->
    </el-collapse>
  </div>
</template>
...
import ElementOtherConfig2 from "./other2/test.vue"
/**
 * 侧边栏
 * @Author MiyueFE
...
export default {
  ...
  methods: {
    ...
    initFormOnChanged(element) {
      ...
      this.moveVisible = this.elementType === "ExclusiveGateway" || this.elementType === "UserTask";
    },
    beforeDestroy() {
