  ...
  setup() {
    ...
    onMounted(() => {
      ...
      const centerImageOption = {
        type: 'image',
        style: {
          image: '/MedicalSystem/MedicalSystem/src/assets/images/item.png',
          x: 'center',
          y: 'center',
          width: 100,
          height: 100,
...
.chart-container {
  background-image: url('/MedicalSystem/MedicalSystem/src/assets/images/order.png');
  display: flex;
