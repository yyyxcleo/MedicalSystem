<template>
          ...
          series: [
            {
              ...
              data: [
                { value: 60, name: '出库',itemStyle: { color: '#5EAEF6' } },
                { value:100,name:'入库',itemStyle: { color: '#E86283' }}
                // 添加更多数据项以表示不同的数据片段
              ],
              itemStyle: {
  ...
  <style scoped>
  .chart-container {
    background-image: url('/MedicalSystem/MedicalSystem/src/assets/images/item.png');
    display: flex;
