      ...
      <div class="boxleft">
        <div class="photobox">
          ...
          <div class="buttonbox">
              ...
              <el-button @click="upload" class="btn">上传图片</el-button>
          </div>
        </div>
  <div class="result">
          <div class="tabletop">
            <img src="/src/assets/images/ai.png" class="img">
            <span v-if="isdetected || !ischeck">AI预测结果展示如下（结果仅供参考，请结合您的自身经验综合考量）</span>
            <span v-else>请点击“开始诊断”按钮</span>
          </div>
          <div class="leftbottom" >
            <div :class="{ loader: true, loading: isLoading }" v-show="isLoading"></div>
            <div class="table" v-show="isdetected || !ischeck">
...
const isLoading = ref(false);
  ...
  const Data = ref([
        { name: "黑色素痣", rate: 0.972 },
        { name: "基底细胞癌", rate: 0.058},
        { name: "黑色素瘤", rate: 0.0273 },
      ]);
  const Data2 = ref([
 ...
 const startCaptureTimer = () => {setTimeout(capturePhoto, 1000); // 1秒后执行 capturePhoto
  };
...
function detect(){
  ...
  setTimeout(() => {
      ...
      isdetected.value = !isdetected.value;
